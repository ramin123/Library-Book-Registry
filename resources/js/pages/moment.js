...
(function(undefined) {
    ...
    ************************************/
    ...
    function dayOfYearFromWeeks(year, week, weekday, firstDayOfWeekOfYear, firstDayOfWeek) {
        ...
        daysToAdd =
            firstDayOfWeek - d + (d > firstDayOfWeekOfYear ? 7 : 0) - (d < firstDayOfWeek ? 7 : 0);
    ...
    ************************************/
    ...
    moment.lang = deprecate('moment.lang is deprecated. Use moment.locale instead.', function(
        key,
        value
    ) {
    ...
    ************************************/
    ...
    extend((moment.fn = Moment.prototype), {
        ...
        dayOfYear: function(input) {
            var dayOfYear =
                round((moment(this).startOf('day') - moment(this).startOf('year')) / 864e5) + 1;
        ...
        weekYear: function(input) {
            var year = weekOfYear(this, this.localeData()._week.dow, this.localeData()._week.doy)
                .year;
