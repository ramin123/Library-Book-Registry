    ...
    Popup.prototype = {
        ...
        splitOptions: function() {
            ...
            if (!$.fn[this.containerName]) {
                throw new Error(
                    this.containerName + ' not found. Have you included corresponding js file?'
                );
            }
...
(function($) {
    ...
    $.extend($.fn.editableform.Constructor.prototype, {
        ...
        initInput: function() {
            ...
            var emptyInputClass =
                this.input.options.inputclass === null || this.input.options.inputclass === false;
...
(function($) {
    ...
    $.extend(Date.prototype, {
        ...
        value2str: function(value) {
            return value
                ? this.dpg.formatDate(value, this.parsedFormat, this.options.datepicker.language)
                : '';
        },
