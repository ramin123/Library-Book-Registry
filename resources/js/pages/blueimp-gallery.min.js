!(function(t) {
    ...
    function e(t, i) {
        return void 0 === document.body.style.maxHeight
            ...
            ? void (t && t.length
                  ? ((this.list = t), (this.num = t.length), this.initOptions(i), this.initialize())
                  : this.console.log(
        ...
        t.extend(e.prototype, {
                        ...
                        for (
                            this.options.continuous || (t = this.circle(t)),
                                ...
                                this.options.continuous &&
                                    ((s = i),
                                    (i = -this.positions[this.circle(t)] / this.slideWidth) !== s &&
                                        (t = -i * this.num + t)),
                                n = Math.abs(o - t) - 1;
                            n;
            ...
            onmousedown: function(t) {
                t.which &&
                    ...
                    (t.preventDefault(),
                    ((t.originalEvent || t).touches = [{ pageX: t.pageX, pageY: t.pageY }]),
                    this.ontouchstart(t));
            },
            ...
            oncomplete: function(e) {
                ...
                s &&
                    ...
                    'error' === e.type
                        ? (t(n).addClass(this.options.slideErrorClass), (this.elements[i] = 3))
                        : (this.elements[i] = 2),
            ...
            setTitle: function(t) {
                var e = this.slides[t].firstChild,
                    ...
                    s = this.titleElement;
                s.length &&
                    (this.titleElement.empty(), i && s[0].appendChild(document.createTextNode(i)));
            },
                ...
                function s(e) {
                    if (!n) {
                        ...
                        (n = !0),
                            ...
                            d &&
                                'load' === e.type &&
                                ((o.style.background = 'url("' + h + '") center no-repeat'),
            ...
            initStartIndex: function() {
                ...
                if (e && 'number' != typeof e)
                    for (t = 0; t < this.num; t += 1)
                        if (
                            this.list[t] === e ||
                            this.getItemProperty(this.list[t], i) === this.getItemProperty(e, i)
                        ) {
                            e = t;
                            break;
                        }
            ...
            initOptions: function(e) {
                (this.options = t.extend({}, this.options)),
                    ((e && e.carousel) || (this.options.carousel && (!e || !1 !== e.carousel))) &&
            ...
            t.extend(s.prototype, {
                ...
                pause: function() {
                    this.ready
                        ...
                        : this.playStatus &&
                          (delete this.playOnReady, this.listeners.pause(), delete this.playStatus);
                },
            }),
            t.extend(e.prototype, {
                VimeoPlayer: s,
