!(function(a, b) {
    ...
    var b = {
        init: function(b) {
            if (
                ((this.options = a.extend({}, a.noty.defaults, b)),
                (this.options.layout = this.options.custom
                    ? a.noty.layouts.inline
                    : a.noty.layouts[this.options.layout]),
                a.noty.themes[this.options.theme]
                    ? ((this.options.theme = a.noty.themes[this.options.theme]),
                      this.options.theme.template &&
                          (this.options.template = this.options.theme.template),
                      this.options.theme.animation &&
        ...
        _build: function() {
            var b = a('<div class="noty_bar noty_type_' + this.options.type + '"></div>').attr(
                'id',
                this.options.id
            );
            if (
                ...
                (this.$bar =
                    null !== this.options.layout.parent.object
                        ? a(this.options.layout.parent.object)
                ...
                var c;
                this.$bar.find('.noty_buttons').length > 0
                    ? (c = this.$bar.find('.noty_buttons'))
                    : ((c = a('<div/>').addClass('noty_buttons')),
                      null !== this.options.layout.parent.object
                          ? this.$bar.find('.noty_bar').append(c)
                          : this.$bar.append(c));
                var d = this;
                a.each(this.options.buttons, function(b, e) {
                    var f = a('<button/>')
                        .addClass(e.addClass ? e.addClass : 'gray')
                        .html(e.text)
                        .attr('id', e.id ? e.id : 'button-' + b)
                        .attr('title', e.title)
                        .appendTo(c)
                        .on('click', function(b) {
        ...
        show: function() {
            ...
            return (
                b.options.custom
                    ? b.options.custom.find(b.options.layout.container.selector).append(b.$bar)
                    : a(b.options.layout.container.selector).append(b.$bar),
                b.options.theme && b.options.theme.style && b.options.theme.style.apply(b),
                'function' === a.type(b.options.layout.css)
                    ? this.options.layout.css.apply(b.$bar)
                ...
                (b.showing = !0),
                b.options.theme &&
                    b.options.theme.style &&
                    b.options.theme.callback.onShow.apply(this),
                a.inArray('click', b.options.closeWith) > -1 &&
                    b.$bar.css('cursor', 'pointer').on('click', function(a) {
                        b.stopPropagation(a),
                            b.options.callback.onCloseClick &&
                                b.options.callback.onCloseClick.apply(b),
                            b.close();
                    }),
                a.inArray('hover', b.options.closeWith) > -1 &&
                    b.$bar.one('mouseenter', function() {
                        b.close();
                    }),
                a.inArray('button', b.options.closeWith) > -1 &&
                    b.$closeButton.one('click', function(a) {
                        b.stopPropagation(a), b.close();
                    }),
                a.inArray('button', b.options.closeWith) == -1 && b.$closeButton.remove(),
                b.options.callback.beforeShow && b.options.callback.beforeShow.apply(b),
                'string' == typeof b.options.animation.open
                    ? ((b.animationTypeOpen = 'css'),
                      b.$bar.css('min-height', b.$bar.innerHeight()),
                      ...
                      b.$bar
                          .addClass(b.options.animation.open)
                          .one(
                              'webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend',
                              function() {
                                  b.options.callback.afterShow &&
                                      b.options.callback.afterShow.apply(b),
                                      (b.showing = !1),
                                      (b.shown = !0),
                                      b.hasOwnProperty('wasClicked') &&
                                          (b.$bar.off('click', function(a) {
                                              b.wasClicked = !0;
                                          }),
                                          b.close());
                              }
                          ))
                    : 'object' == typeof b.options.animation.open &&
                      null == b.options.animation.open
                    ? ((b.animationTypeOpen = 'none'),
                      (b.showing = !1),
                      (b.shown = !0),
                      b.$bar.show(),
                      b.options.callback.onShow && b.options.callback.onShow.apply(b),
                      b.$bar.queue(function() {
                          b.options.callback.afterShow && b.options.callback.afterShow.apply(b);
                      }))
                    : ((b.animationTypeOpen = 'anim'),
                      b.options.callback.onShow && b.options.callback.onShow.apply(b),
                      b.$bar.animate(
                          b.options.animation.open,
                          b.options.animation.speed,
                          b.options.animation.easing,
                          function() {
                              b.options.callback.afterShow && b.options.callback.afterShow.apply(b),
                                  (b.showing = !1),
                                  (b.shown = !0);
                ...
                b.options.timeout &&
                    (b.queueClose(b.options.timeout),
                    b.$bar.on('mouseenter', b.dequeueClose.bind(b)),
                    b.$bar.on('mouseleave', b.queueClose.bind(b, b.options.timeout))),
                this
            );
        },
        ...
        queueClose: function(a) {
            if (!this.closeTimer) {
                var b = this;
                return (
                    (b.closeTimer = window.setTimeout(function() {
                        b.close();
                    }, a)),
                    b.closeTimer
                );
        ...
        close: function() {
            if (
                ...
                if (
                    this.showing &&
                    ('anim' == this.animationTypeOpen || 'none' == this.animationTypeOpen)
                )
                ...
                if (
                    ...
                    var c = [];
                    return (
                        a.each(a.noty.queue, function(a, d) {
                ...
                b.$bar.addClass('i-am-closing-now'),
                    ...
                    'string' == typeof b.options.animation.close
                        ? b.$bar
                              .removeClass(b.options.animation.open)
                              .addClass(b.options.animation.close)
                              .one(
                                  'webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend',
                                  function() {
                                      b.options.callback.afterClose &&
                                          b.options.callback.afterClose.apply(b),
                                          b.closeCleanUp();
                                  }
                              )
                        : 'object' == typeof b.options.animation.close &&
                          null == b.options.animation.close
                        ? b.$bar.dequeue().hide(0, function() {
                              b.options.callback.afterClose &&
                                  b.options.callback.afterClose.apply(b),
                                  b.closeCleanUp();
                          })
        ...
        closeCleanUp: function() {
            ...
            b.options.modal &&
                ...
                0 != a.notyRenderer.getModalCount() ||
                    a.noty.queue.length ||
                    a('.noty_modal').fadeOut(b.options.animation.fadeSpeed, function() {
                        a(this).remove();
                    })),
                a.notyRenderer.setLayoutCountFor(b, -1),
                0 == a.notyRenderer.getLayoutCountFor(b) &&
                    a(b.options.layout.container.selector).remove(),
                'undefined' != typeof b.$bar && null !== b.$bar
                    ? 'string' == typeof b.options.animation.close
                        ? (b.$bar
                              .css('transition', 'all 10ms ease')
                              .css('border', 0)
                              .css('margin', 0)
                              .height(0),
                          b.$bar.one(
                              ...
                              function() {
                                  b.$bar.remove(),
                                      (b.$bar = null),
                                      (b.closed = !0),
                                      b.options.theme.callback &&
                                          b.options.theme.callback.onClose &&
                                          b.options.theme.callback.onClose.apply(b),
                                      b.handleNext();
                              }
                          ))
                        : (b.$bar.remove(), (b.$bar = null), (b.closed = !0), b.handleNext())
                    : b.handleNext();
        },
        handleNext: function() {
            var b = this;
        ...
        setText: function(a) {
            return (
                this.closed || ((this.options.text = a), this.$bar.find('.noty_text').html(a)), this
            );
        },
        setType: function(a) {
            return (
    ...
    (a.notyRenderer = {}),
        (a.notyRenderer.init = function(c) {
            ...
            return (
                d.options.killer && a.noty.closeAll(),
        ...
        (a.notyRenderer.render = function() {
            ...
            'object' === a.type(b)
                ? b.options.dismissQueue
                    ? b.options.maxVisible > 0
                        ? a(b.options.layout.container.selector + ' > li').length <
                              b.options.maxVisible && a.notyRenderer.show(a.noty.queue.shift())
                        : a.notyRenderer.show(a.noty.queue.shift())
                    : a.noty.ontap &&
                      (a.notyRenderer.show(a.noty.queue.shift()), (a.noty.ontap = !1))
                : (a.noty.ontap = !0);
        }),
        (a.notyRenderer.show = function(b) {
            b.options.modal && (a.notyRenderer.createModalFor(b), a.notyRenderer.setModalCount(1)),
                b.options.custom
                    ? 0 == b.options.custom.find(b.options.layout.container.selector).length
                        ? b.options.custom.append(
                              a(b.options.layout.container.object).addClass('i-am-new')
                          )
                        : b.options.custom
                              .find(b.options.layout.container.selector)
                              .removeClass('i-am-new')
                    : 0 == a(b.options.layout.container.selector).length
                    ? a('body').append(a(b.options.layout.container.object).addClass('i-am-new'))
                    : a(b.options.layout.container.selector).removeClass('i-am-new'),
                a.notyRenderer.setLayoutCountFor(b, 1),
                b.show();
        }),
        (a.notyRenderer.createModalFor = function(b) {
            if (0 == a('.noty_modal').length) {
                var c = a('<div/>')
                    .addClass('noty_modal')
                    .addClass(b.options.theme)
                    .data('noty_modal_count', 0);
                b.options.theme.modal &&
                    b.options.theme.modal.css &&
                    c.css(b.options.theme.modal.css),
                    c.prependTo(a('body')).fadeIn(b.options.animation.fadeSpeed),
                    a.inArray('backdrop', b.options.closeWith) > -1 &&
                        c.on('click', function() {
                            a.noty.closeAll();
                        });
            }
        ...
        (a.notyRenderer.setLayoutCountFor = function(b, c) {
            return a(b.options.layout.container.selector).data(
                'noty_layout_count',
                a.notyRenderer.getLayoutCountFor(b) + c
            );
        }),
    ...
    return (
        ...
        (a.noty.layouts.centerLeft = {
            ...
            container: {
                ...
                style: function() {
                    ...
                    b.remove(),
                        a(this).hasClass('i-am-new')
                            ? a(this).css({ top: (a(window).height() - c) / 2 + 'px' })
                            : a(this).animate({ top: (a(window).height() - c) / 2 + 'px' }, 500),
                        window.innerWidth < 600 && a(this).css({ left: 5 });
                },
            },
            parent: { object: '<li />', selector: 'li', css: {} },
                        ...
                        switch (this.options.layout.name) {
                            case 'top':
                                a(b).css({ borderRadius: '0px 0px 0px 0px' }),
                                    a(b)
                                        .last()
                                        .css({ borderRadius: '0px 0px 5px 5px' });
                                break;
                            case 'topCenter':
                            case 'topLeft':
                            case 'topRight':
                            ...
                            case 'bottom':
                                a(b).css({ borderRadius: '0px 0px 0px 0px' }),
                                    a(b)
                                        .first()
                                        .css({ borderRadius: '5px 5px 0px 0px' });
                        }
                    }
                },
            },
        ...
        (a.noty.themes.metroui = {
            ...
            style: function() {
                switch (
                    (this.$bar.css({ overflow: 'hidden', margin: '4px 0', borderRadius: '0' }),
                    this.$message.css({
                        textAlign: 'center',
                        padding: '1.25rem',
                        width: 'auto',
        ...
        (a.noty.themes.relax = {
            ...
            style: function() {
                switch (
                    (this.$bar.css({ overflow: 'hidden', margin: '4px 0', borderRadius: '2px' }),
                    this.$message.css({
                        textAlign: 'center',
                        padding: '10px',
                        width: 'auto',
        ...
        (a.noty.themes.semanticUI = {
            ...
            animation: {
                open: { animation: 'fade', duration: '800ms' },
                close: { animation: 'fade left', duration: '800ms' },
            },
            modal: {
                css: {
                    position: 'fixed',
            ...
            style: function() {
                switch (
                    ...
                    this.$bar.css({ margin: '0.5em' }),
                    this.options.icon &&
                        this.$message
                            .addClass('icon')
                            .prepend(a('<i/>').addClass(this.options.icon)),
                    this.options.size)
                ) {
                    case 'mini':
