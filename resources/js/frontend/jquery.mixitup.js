    ...
    $.MixItUp.prototype = {
        ...
        _bindHandlers: function() {
            ...
            filters[self.selectors.filter] =
                filters[self.selectors.filter] === undf ? 1 : filters[self.selectors.filter] + 1;
            sorts[self.selectors.sort] =
                sorts[self.selectors.sort] === undf ? 1 : sorts[self.selectors.sort] + 1;
        ...
        _parseSort: function(sortString) {
            ...
            for (var i = 0; i < rules.length; i++) {
                var rule =
                        typeof sortString === 'string' ? rules[i].split(':') : ['custom', rules[i]],
                    ruleObj = {
                ...
                buildTransform = function(key, invert) {
                    ...
                    for (var i = 0; i < transforms.length; i++) {
                        ...
                        effects[key] += parse(prop)
                            ? prop + '(' + negate(parse(prop, true).val || def, inverted) + ') '
                            : '';
                    }
                };
        ...
        multiMix: function() {
            ...
            if (!self._mixing) {
                ...
                self._goMix(
                    args.animate ^ self.animation.enable ? args.animate : self.animation.enable
                );
