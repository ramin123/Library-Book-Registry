...
(function(app, win) {
            ...
            if (dimensions) {
                ...
                if (holder.fluid_data.fluid_width && !holder.fluid_data.fluid_height) {
                    ...
                    holder.fluid_data.ratio =
                        holder.initial_dimensions.width / parseFloat(holder.dimensions.height);
                } else if (!holder.fluid_data.fluid_width && holder.fluid_data.fluid_height) {
                    holder.fluid_data.mode = 'height';
                    holder.fluid_data.ratio =
                        parseFloat(holder.dimensions.width) / holder.initial_dimensions.height;
                }
            }
        }
    }
    ...
    app.run = function(o) {
        ...
        instance_config.debounce =
            options.debounce != null ? options.debounce : instance_config.debounce;
