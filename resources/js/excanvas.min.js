if (!document.createElement('canvas').getContext) {
    (function() {
                ...
                switch (AJ.type) {
                    ...
                    case 'wa':
                        k.push(
                            ...
                            AJ.type,
                            ' ',
                            T(AJ.x - this.arcScaleX_ * AJ.radius),
                            ',',
                            T(AJ.y - this.arcScaleY_ * AJ.radius),
                            ' ',
                            T(AJ.x + this.arcScaleX_ * AJ.radius),
                            ',',
                            T(AJ.y + this.arcScaleY_ * AJ.radius),
        ...
        J.getCoords_ = function(f, e) {
            var Z = this.m_;
            return {
                x: A * (f * Z[0][0] + e * Z[1][0] + Z[2][0]) - L,
                y: A * (f * Z[0][1] + e * Z[1][1] + Z[2][1]) - L,
            };
        };
        J.save = function() {
            var Z = {};
