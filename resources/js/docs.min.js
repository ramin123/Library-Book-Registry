        ...
        (f = h ? o(f, { text: h }) : f),
            ...
            'image' == a
                ...
                : 'fluid' == a &&
                  ...
                  j(b),
                  r.use_fallback ? (b.style.backgroundColor = f.background) : (v.push(b), k(b)));
    }
    function i(a, b) {
                ...
                if (e.holder_data) {
                    ...
                    if (h) {
                        if (f.fluid) {
                            ...
                            e.setAttribute(
                                'src',
                                g({ ctx: w, dimensions: h, template: f.theme, ratio: x, holder: f })
                            );
                        }
                        f.textmode &&
                            'exact' == f.textmode &&
    ...
    (a.invisible_error_fn = function() {
        ...
        (a.run = function(b) {
            ...
            var c = o(y, b),
                ...
                f = [];
            for (
                null != c.use_canvas && c.use_canvas && ((r.use_canvas = !0), (r.use_svg = !1)),
                    ...
                    'string' == typeof c.bgnodes
                        ...
                        ? (f = c.bgnodes)
                        : window.Node && c.bgnodes instanceof window.Node && (f = [c.bgnodes]),
                    k = 0,
                    j = e.length;
                j > k;
                k++
            ...
            for (j = d.length, k = 0; j > k; k++) {
                ...
                if (
                    (null == attr_datasrc && w && w.indexOf(c.domain) >= 0
                        ? (m = w)
                        : attr_datasrc && attr_datasrc.indexOf(c.domain) >= 0 && (m = attr_datasrc),
                    m)
                ) {
                    var u = l(
