...
<link href="{{ asset('vendors/noty/css/noty.css') }}" rel="stylesheet" />
    <link href="{{ asset('css/pages/fluid.css') }}"  rel="stylesheet"/>
...
<script src="{{ asset('js/pages/jquery.noty.packaged.min.js') }}" ></script>
<script src="{{ asset('js/pages/noty_script.js') }}" ></script>
