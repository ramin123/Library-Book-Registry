            ...
            <div class="card ">
                <div class="card-header clearfix bg-primary text-white">
                    ...
                    <div class="float-right">
                        <a href="{{ URL::to('admin/genres/create') }}" class="btn btn-sm btn-secondary"><span
...
@section('footer_scripts')
    ...
    <script>
        ...
        $('#delete_confirm').on('show.bs.modal', function (event) {
            ...
            var modal = $(this);
            modal.find('.modal-footer a').prop("href",$url_path+"/admin/genres/"+$recipient+"/delete");
        })
    </script>
@stop
