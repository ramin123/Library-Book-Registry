    ...
    <section class="content pr-3 pl-3">
        ...
        <div class="row">
            ...
            <div class="the-box no-border">
                <!-- errors -->
                <form action="{{ route('admin.books.updated',$book->id)  }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <input type="date" name="publication_year" value="{{ $book->publication_year }}" class="form-control" placeholder="Year">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="form-group {{ $errors->first('type', 'has-error') }}">
                                ...
                                <select class="form-control" id="type" name="type">
                                    ...
                                    <option value="graphic" <?php if($book->type == 'graphic') {?> selected="selected" <?php } ?> >graphic</option>
                                    <option value="digital" <?php if($book->type == 'digital') {?> selected="selected" <?php } ?> >digital</option>
                                    <option value="printed" <?php if($book->type == 'printed') {?> selected="selected" <?php } ?>>printed</option>
                                </select>
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="form-group {{ $errors->first('author_id', 'has-error') }}">
                                ...
                                <select class="form-control" id="author_id" name="author_id">
                                    ...
                                    <option value="{{ $value->id }}" <?php if($book->author_id == $value->id ) {?> selected="selected" <?php } ?>>{{ $value->name }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="form-group {{ $errors->first('genre_id', 'has-error') }}">
                                ...
                                @foreach($genre as $value)
                                    <option value="{{ $value->id }}" <?php if($book->genre_id == $value->id ) {?> selected="selected" <?php } ?> >{{ $value->name }}</option>
                                    @endforeach
                                </select>
